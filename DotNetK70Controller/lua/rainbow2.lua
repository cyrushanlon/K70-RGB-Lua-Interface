...
print("Up arrow to increase slope.\nDown arrow to decrease slope.\n")
...
function main()
	...
	if Reverse then
		Ticks = Ticks - 1
		if Ticks < 1 then
			Ticks = Ticks + TicksPerCycle*SlinkySlopeTicks*SlinkyFadeTicks
		end
	else
		Ticks = Ticks + 1
	end
